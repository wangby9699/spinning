package com.example.spinning.controller.admin;

import com.example.spinning.bean.Article;
import com.example.spinning.bean.RespBean;
import com.example.spinning.service.ArticleService;
...
public class AdminController {
    ...
    public Map<String, Object> getArticleByStateByAdmin(@RequestParam(value = "page", defaultValue = "1") Integer page, @RequestParam(value = "count", defaultValue = "6") Integer count, String keywords) {
        List<Article> articles = null;
                articles=articleService.getArticleByState(-2, page, count, keywords);
